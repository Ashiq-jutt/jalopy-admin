...
export default function PartnerList({ accountactive, toast, token }) {
  ...
  return (
    <>
      ...
      <div className={`${hide ? "hidden" : "w-[90%]"} md:w-[33%] md:block text-main-color absolute md:relative z-10 ${accountactive ? "h-[calc(100vh-100px)] md:h-[calc(100vh-270px)]" : "h-[calc(100vh-175px)]"} overflow-y-auto  bg-[white] `}>
        <i onClick={() => {
          setHide(true)
        }} className={` ${!hide ? "" : ""} cursor-pointer ml-[calc(100%-50px)] md:hidden pi pi-arrow-right`} />
