...
export default function AllConnections({ accountactive, toast, token, setConversationUser }) {
  ...
  return (
    <>
      ...
      <div className={`${hide ? "hidden" : "w-[98%]"} md:w-[33%] md:block absolute   md:relative z-10 ${accountactive ? "h-[calc(100vh-100px)] md:h-[calc(100vh-270px)]" : "h-[calc(100vh-175px)]"} overflow-y-auto   bg-[white] `}>
        <i onClick={() => {
          setHide(true)
        }} className={` ${!hide ? "" : ""}  cursor-pointer md:hidden text-main-color pi pi-arrow-left`} />
