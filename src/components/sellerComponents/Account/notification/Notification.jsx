  ...
  const toast = useRef();
   useEffect(()=>{ 
    Axios.get(
      ...
      toast.current.show({ severity: "success", summary: "Info", detail: <p className="font-poppins ">{res?.data?.message ? res?.data?.message :"Notification Settings Fetched Successfully "}</p> });
            ...
            toast.current.show({ severity: "success", summary: "Info", detail: <p className="font-poppins ">{res?.data?.message ? res?.data?.message :"Notification Settings Fetching  Failed"}</p> });
