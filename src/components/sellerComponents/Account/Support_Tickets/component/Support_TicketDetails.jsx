...
RenderTickets()
 ...
 const HiddenReload=()=>{ 
  ...
  return (
    <div className={`p-2 flex z-99999 flex-wrap flex-row justify-between overflow-y-auto font-poppins fixed bg-white    ${accountactive ? "  ml-[-35px] w-full md:w-[calc(100%-320px)]":""} h-[100vh] md:h-[calc(100%-70px)] top-[70px]  text-main-color`}>
