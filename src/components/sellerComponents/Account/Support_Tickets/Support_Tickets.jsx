...
export default function SupportTickets({accountactive}){ 
  ...
  const [showSupport,setShowSupport]=useState(false)  
     ...
     return( 
         <div className="w-full">   
              { 
              detailView ? <SupportTicketDetail  accountactive={accountactive} setRefresh={setRefresh}  token={token} data={data} setDetailView={setDetailView} /> :
        <div>  
