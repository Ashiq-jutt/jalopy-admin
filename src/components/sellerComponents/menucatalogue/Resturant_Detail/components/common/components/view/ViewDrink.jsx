...
export default function ViewDrink({ setShowAiDetailView,itemData }) {  
  ...
  const [detailData,setDetailData]=useState()
   ...
   return (
    ...
    e.target.src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTw_HeSzHfBorKS4muw4IIeVvvRgnhyO8Gn8w&s"
       ...
       <div className="flex flex-wrap mt-8 flex-row justify-around gap-4 w-full">  
         
         <Button label="Edit" type="button" className="border w-[100px] border-main-color bg-main-color text-white pl-4 pr-4 p-1" />
