...
export default function CarDetails({cardetails,setShowDetails}){    
  ...
  const [showEditComponent,setShowEditComponent]=useState(false) 
     ...
     <h1 className="md:w-[200px]  font-normal mt-4  inline font-poppins">
       {cardetails?.carNo}
     </h1>        
     </div>      
     <div className="mt-4 flex flex-wrap flex-row justify-between">
     ...
     <h1 className="w-[200px] font-normal inline mt-4 font-poppins">
       {cardetails?.registerationDate ? moment.utc(cardetails?.registerationDate).format(format('DD MMM YYYY [at] HH:mm')):""}
     </h1>
       </div> 
       <div className="mt-4 flex flex-wrap flex-row justify-between">
