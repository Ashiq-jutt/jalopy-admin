  ...
  const [showEditComponent,setShowEditComponent]=useState(false) 
     ...
     <h1 className="w-[calc(100%-155px)] md:w-[200px] font-normal inline mt-4 font-poppins">
      ...
      .catch(error => console.error('Download failed:', error));
       ...
       }} className="underline cursor-pointer">Image</h1> : "Not Submitted"}
     </h1>        
     </div>         
     <div className="mt-4 flex flex-wrap flex-row justify-between">
     ...
     <h1 className="w-[calc(100%-155px)] md:w-[200px] font-normal inline mt-4 font-poppins">
      ...
      .catch(error => console.error('Download failed:', error));
       ...
       }} className="underline cursor-pointer">ID Card</h1> : "Not Submitted"}
     </h1>        
     </div>      
     <div className="mt-4 flex flex-wrap flex-row justify-between">
     ...
     <h1 className="w-[calc(100%-155px)] md:w-[200px] font-normal inline mt-4 font-poppins">
      ...
      .catch(error => console.error('Download failed:', error));
       ...
       }} className="underline cursor-pointer">Transport License File</h1> :"Not Submitted"}
     </h1>        
     </div>    
