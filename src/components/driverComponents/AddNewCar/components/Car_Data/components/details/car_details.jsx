...
export default function CarDetails({cardetails,setShowDetails}){   
  const [showEditComponent,setShowEditComponent]=useState(false) 
     ...
     <h1 className="font-normal font-poppins mt-4 ml-3 ">
       {cardetails.carData.lastname}, {cardetails.carData.fullName}
     </h1>   
     </div> 
      <div className="mt-4">
