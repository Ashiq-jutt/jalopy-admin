                    ...
                    <p className="text-center mt-8">Faceook</p> 
                      <div className="w-full border-b border-main-color mt-4">  
                          ...
                          <div className="flex flex-wrap flex-row justify-center w-full">  
                           <InputText name="facebook" className="border mt-4 p-1 w-[90%] text-[rgba(0,0,0,.7)]  border-[#EEEEEE] rounded-md" value={formik.values.facebook} onChange={formik.handleChange}  placeholder="Facebook Link"/>
                          </div>
                </div>
...
<p className="text-center mt-8">instagram</p> 
                      <div className="w-full border-b border-main-color mt-4">  
                        ...
                        <div className="flex flex-wrap flex-row justify-center w-full">  
                           <InputText name="instagram" className="border mt-4 p-1 text-[rgba(0,0,0,.7)] w-[90%]  mb-4 border-[#EEEEEE] rounded-md" value={formik.values.instagram} onChange={formik.handleChange}  placeholder="Instagram Link"/>
                          </div>
                 </div> 
...
<p className="text-center mt-8">Twitter</p>  
                      <div className="w-full border-b border-main-color mt-4">  
                        ...
                        <div className="flex flex-wrap flex-row justify-center w-full">  
                           <InputText name="twitter" className="border mt-4 p-1  text-[rgba(0,0,0,.7)] border-[#EEEEEE] mb-4 w-[90%] rounded-md" value={formik.values.twitter} onChange={formik.handleChange}  placeholder="Twiiter Link"/>
                          </div>
                 </div>    
