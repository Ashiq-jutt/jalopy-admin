...
export default function ConnectionMessage({ accountactive, toast, conversationUser, token }) {
  ...
  return (
    <div className={`w-[99%] md:w-[33%] ${accountactive ? "h-[calc(100vh-100px)] md:h-[calc(100vh-270px)]" : "h-[calc(100vh-175px)]"}  overflow-y-auto overflow-y-auto`}>
