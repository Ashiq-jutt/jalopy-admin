...
export default function AddDrink({ setShowAiDetailView, VendorShopId }) {
  const toast = useRef();
  ...
  useEffect(() => {
    Axios.get(
      ...
      {
        params: { VendorShopId: VendorShopId },
    ...
    <form onSubmit={formik.handleSubmit} className="p-2">
      <div className="mt-0 mb-10 flex  font-poppins font-normal flex-wrap flex-row justify-center sm:justify-center md:justify-between lg:justify-between">
        <div className="mt-4 flex w-full flex-wrap items-start flex-row justify-center gap-4  md:justify-start">
          <label className="text-left md:text-center md:w-auto w-[90%]">Item Image</label>
          <div onClick={() => {
            productPicRef.current.click()
          }} className="  cursor-pointer text-main-color md:w-[40%] overflow-hidden w-[90%] text-white flex flex-wrap flex-row justify-left gap-2 items-start">
          ...
          {productimg ? <div className="flex flex-wrap flex-row justify-center items-center ">
            <div className="overflow-hidden w-[200px]    rounded-md h-[200px] flex flex-wrap flex-row justify-center items-center overflow-hIdden" >
