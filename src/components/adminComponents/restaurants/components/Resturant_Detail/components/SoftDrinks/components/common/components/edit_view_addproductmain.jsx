...
export default function EditViewAddDrinks({ vendorId, setShowAiDetailView, setRefresh, aiDrinkData, itemData }) {
   ...
   return (
      <div>
         ...
         {
            editActive ? <EditDrink vendorId={vendorId} itemData={itemData} /> : viewActive ? <ViewDrink setShowAiDetailView={setShowAiDetailView} itemData={itemData} /> : addActive ? <AddDrink setShowAiDetailView={setShowAiDetailView} vendorId={vendorId} aiDrinkData={aiDrinkData} /> : undefined
         }
