...
export default function DeliveryPickupFreeRide({vendorId}) {   
 ...
 const [blockedPostalCodes2,setBlockedPostalCodes2]=useState([])         
  ...
  function CreatePostalCode(){  
    ...
    Axios.post(
      `${process.env.REACT_APP_BASE_URL}/api/v1/BlockPostalCodes/Create`,{vendorId:vendorId,code:postalCode},
  ...
  return (
    <div className=" font-poppins p-4 ">
      <div className="flex flex-wrap flex-row justify-center">
        ...
        <div className="  pt-[40px]  w-full flex flex-row flex-wrap justify-between"> 
         { freeRide.length !== 0 ? <div className="w-full  overflow-x-auto">
          {freeRide.map((item) => (
          ...
          <div className="flex flex-wrap flex-row  mt-4 items-center justify-left">
            ...
            <div className=" text-white  rounded w-full  flex flex-wrap flex-row items-center justify-left  p-2 pl-[0px] ">
             <label className="text-main-color">Pick Up Rebate</label>
              <p className="  text-white bg-main-color  w-[112px]  rounded-sm ml-2 flex flex-wrap flex-row items-center justify-center  p-2">
                <i  onClick={()=>{ 
                   if(pickupRebate >=0){ 
      ...
      <div className="flex flex-wrap mt-10 blocktable flex-row  justify-between">  
            <div className="w-[48%] border border-main-color"> 
               { 
                 blockedPostalCodes1.map(item=>(
                    <div className="p-1 w-full  border-main-color border-b last:border-none  items-center flex flex-wrap border-main-color w-full flex-row justify-between">  
            ...
            <div className="w-[48%] border border-main-color "> 
               { 
                 blockedPostalCodes2.map(item=>(
                    <div className="w-full p-1  flex flex-wrap border-b border-main-color items-center last:border-none w-full flex-row justify-between">  
                            <p className="text-main-color ">{item.code}</p> 
                                <Button  onClick={()=>{ 
                                   setUnblockDialog(prev=>!prev) 
                                   setSelectedBlock(item)
      ...
      label="Inquiry"
        ...
        <Toast className="mt-[70px]" ref={toast} /> 
