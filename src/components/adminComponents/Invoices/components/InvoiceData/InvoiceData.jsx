...
export default function InvoicesData() {
  ...
  const tableActions = (rowData) => {
    return (
      <div className="w-full bg-white  flex flex-wrap flex-row justify-evenly">
        {" "}
        <Button
          onClick={() => { 
  ...
  return (
    <div>
      <div className=" text-main-color font-poppins mt-4  items-center font-normal flex flex-row flex-wrap gap-4 justify-between">
        <h1 className="text-[21px] font-semibold tracking-wide ">All Invoices</h1>
        <Button  label="Add New"   icon="pi pi-plus" className="w-full h-[35px] mt-1 md:w-[150px] bg-main-color text-white  p-1 pl-2 pr-2 "/>
      ...
      >
        ...
        <Column header="Date"
          ...
          body={(rowData) => {
            return (
              <p>{rowData?.issueDate ? moment(rowData?.issueDate).utc().format("DD MMMM yyyy, [at] hh:mm a") : ""}</p>
            )
          }}
        ></Column>
        ...
        <Column header="Due Date"
          ...
          body={(rowData) => {
            return (
              <p>{rowData?.dueDate ? moment(rowData?.dueDate).utc().format("DD MMMM yyyy, [at] hh:mm a")  : ""}</p>
            )
          }}
        ></Column>
