...
export default function EditResturantDetail({ ref,resturantDetailView,setShowEditComponent,setShowResturantDetail }) { 

  const formik = useFormik({
    initialValues: {
      name: resturantDetailView?.ridepartner,
      ...
      iban:resturantDetailView?.iban,  
      phoneNo:resturantDetailView?.phoneNumber,
  ...
  return (
    <div className=""> 
     <Button label="Back" className="bg-main-color text-white p-1 pr-3 pl-3" onClick={()=>{ 
      ...
      <form>
        <div className=" mb-10 flex  font-poppins font-normal flex-wrap flex-row justify-center sm:justify-center md:justify-between lg:justify-between">
