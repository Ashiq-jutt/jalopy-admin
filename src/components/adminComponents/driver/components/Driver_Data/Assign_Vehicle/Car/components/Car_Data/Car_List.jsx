...
export default function AssignCarsList({carsData,loader,driverDetail}){         
      ...
      <div className="w-full  flex flex-wrap flex-row justify-evenly"> 
          {" "}
            ...
            <Button  
             ...
             label="Assign"  
             className="bg-main-color p-1 pl-2 pr-2 text-white "
          />
            ...
            body={(rowData)=>{ 
              return( 
                <div className="flex flex-wrap justify-left w-[200px] items-center flex-row"> 
                      ...
                      <p className="ml-2">{rowData?.firstName+" "+rowData?.lastName}</p>
                </div>
              )
             }}
            ...
            <h1 className="text-center text-main-color">Do You Want To Assign Vehicle </h1>
             <div className="flex mt-4 flex-wrap flex-row justify-evenly"> 
              <Button  onClick={()=>{ 
                 ...
                 Axios.put(`${process.env.REACT_APP_BASE_URL}/api/v1/Vehicles/AssignDriver?version=1`,{vehicleId:driverDetail?.id,driverId:selectedRow?.id},{headers:{'Authorization':`Bearer ${token}`}}).then((res)=>{ 
               ...
               <Button label="No" className="border text-main-color pl-2 pr-2"></Button>
             </div>
             </Dialog> 
